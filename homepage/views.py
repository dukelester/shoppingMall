...
def profile_view(request):
    ...
    my_dict = {'my_rented_plots': my_rented_plots, 'tenant_plots': tenant_plots, 'shop': shop, 'buy': buy, 'rent': rent,
               'user': user_name, 'bio': info_object.bio, 'phone': info_object.phone, 'city': info_object.city}
