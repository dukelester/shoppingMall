...
urlpatterns = [
    ...
    re_path('transaction_cancel/', views.transaction_cancel, name='credits.transaction_cancel'),
    re_path('redeem_cancel/', views.redeem_cancel, name='credits.redeem_cancel'),
